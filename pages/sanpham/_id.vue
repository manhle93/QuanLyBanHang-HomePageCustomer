  ...
  <v-layout justify-center>
    <div class="page-width">
      ...
      <div class="d-flex" style="flex-wrap: wrap; margin-top: 20px">
        <div style="width: 650px; height: 600px;" class="c-flex">
          <img
            :src="(sanPham.anh_dai_dien && image) ? image : (sanPham.anh_dai_dien && !image) ? END_POINT_IMAGE + sanPham.anh_dai_dien : product"
            style="width: 550px; max-height: 600px"
          />
          <div class="d-flex mt-5 pr-6" style="width: 100%" v-if="sanPham.hinh_anhs.length > 0">
            <div
        ...
        <div class="c-flex flex-fill" style="height: 400px;">
          ...
          <div class="c-flex khung-thuoctinh">
            ...
            >{{formatCurrency(sanPham.gia_ban)}} đ/kg</div>
            ...
            <div class="thuoc-tinh">Thuộc danh mục: {{sanPham.danh_muc.ten_danh_muc}}</div>
          </div>
      ...
      <div style="font-size: 24px; font-weight: bold">Mô tả sản phẩm</div>
    </div>
  </v-layout>
</template>
<script>
